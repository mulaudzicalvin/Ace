...
class AccountInvoice(models.Model):
    ...
    #     if res.partner_id.country_id.code == 'IN':
    #         if res.partner_id.x_gstin:
    #             res.invoice_type = 'b2b'
    #         elif res.amount_total >= 250000:
    #             res.invoice_type = 'b2cl'
    #         else:
    #             res.invoice_type = 'b2cs'
    #     else:
    #         res.invoice_type = 'export'
    #         res.export = 'WOPAY'
    #     return res
